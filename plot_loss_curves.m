%% COMUNE
epoch=xlsread('loss_log_plotting_data_train.xlsx','C4:C13');
%% TRAIN LOSS
G_A_loss_train=xlsread('loss_log_plotting_data_train.xlsx','F2:F13');
D_A_loss_train=xlsread('loss_log_plotting_data_train.xlsx','G4:G13');
%%
cycle_A_loss_train=xlsread('loss_log_plotting_data_train.xlsx','H4:H13');
idt_A_loss_train=xlsread('loss_log_plotting_data_train.xlsx','I4:I13');
%%
G_B_loss_train=xlsread('loss_log_plotting_data_train.xlsx','K4:K13');
D_B_loss_train=xlsread('loss_log_plotting_data_train.xlsx','L4:L13');
%%
cycle_B_loss_train=xlsread('loss_log_plotting_data_train.xlsx','M4:M13');
idt_B_loss_train=xlsread('loss_log_plotting_data_train.xlsx','N4:N13');
%% VALID LOSS
G_A_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','F2:F13');
D_A_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','G4:G13');
%%
cycle_A_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','H4:H13');
idt_A_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','I4:I13');
%%
G_B_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','K4:K13');
D_B_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','L4:L13');
%%
cycle_B_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','M4:M13');
idt_B_loss_valid=xlsread('loss_log_plotting_data_valid.xlsx','N4:N13');
%% TRAIN LOSS PLOTS
fig1=figure(1);
